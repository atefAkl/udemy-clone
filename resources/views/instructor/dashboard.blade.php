...
@section('title', __('app.instructor_dashboard'))
...
<nav aria-label="breadcrumb" class="mb-4">
    <ol class="breadcrumb">
        <li class="breadcrumb-item active" aria-current="page">{{ __('app.instructor_dashboard') }}</li>
    </ol>
</nav>
        ...
        <div class="card bg-gradient-primary text-white border-0 shadow-sm">
            <div class="card-body">
                <div class="row align-items-center">
                    <div class="col-md-8">
                        <h2 class="mb-2">{{ __('app.welcome_instructor') }}, {{ Auth::user()->name }}!</h2>
                        <p class="mb-0 opacity-75">{{ __('app.instructor_welcome_message') }}</p>
                    </div>
    ...
    <div class="col-md-3 col-sm-6 mb-3">
        <div class="card border-0 shadow-sm">
            <div class="card-body text-center">
                ...
                <p class="text-muted mb-0">{{ __('app.total_courses') }}</p>
            </div>
        </div>
    </div>
    <div class="col-md-3 col-sm-6 mb-3">
        <div class="card border-0 shadow-sm">
            <div class="card-body text-center">
                ...
                <p class="text-muted mb-0">{{ __('app.published_courses') }}</p>
            </div>
        </div>
    </div>
    <div class="col-md-3 col-sm-6 mb-3">
    ...
    <div class="col-md-3 col-sm-6 mb-3">
        <div class="card border-0 shadow-sm">
            <div class="card-body text-center">
                ...
                <p class="text-muted mb-0">{{ __('app.total_revenue') }}</p>
            </div>
        </div>
    </div>
</div>
...
<div class="card border-0 shadow-sm mb-4">
    ...
    <div class="card-body">
        ...
        <div class="text-center py-4">
            ...
            <h5 class="text-muted mt-3">{{ __('app.no_courses_yet') }}</h5>
            <p class="text-muted">{{ __('app.start_creating_courses') }}</p>
            <a href="{{ route('instructor.courses.create') }}" class="btn btn-primary">
                <i class="bi bi-plus {{ session('locale', 'ar') === 'ar' ? 'ms-2' : 'me-2' }}"></i>
                {{ __('app.create_first_course') }}
            </a>
        </div>
        @endforelse
    </div>
...
<div class="card border-0 shadow-sm">
    ...
    <div class="card-body">
        <div class="row">
            ...
            <div class="col-md-4">
                <h6 class="mb-3">{{ __('app.top_performing_courses') }}</h6>
                @php
                $topCourses = [
        ...
        <div class="row text-center">
            ...
            <div class="col-6">
                <div class="border-{{ session('locale', 'ar') === 'ar' ? 'start' : 'end' }}">
                    ...
                    <small class="text-muted">{{ __('app.total_reviews') }}</small>
                </div>
            </div>
            <div class="col-6">
                <h4 class="text-warning mb-1">12</h4>
                <small class="text-muted">{{ __('app.this_month') }}</small>
            </div>
        </div>
    </div>
</div>
    ...
    <div class="card-body">
        <div class="d-grid gap-2">
            ...
            <a href="{{ route('instructor.courses.index') }}" class="btn btn-outline-primary">
                ...
                {{ __('app.manage_courses') }}
            </a>
            <a href="#" class="btn btn-outline-success">
                <i class="bi bi-bar-chart {{ session('locale', 'ar') === 'ar' ? 'ms-2' : 'me-2' }}"></i>
                {{ __('app.performance_reports') }}
            </a>
            <a href="#" class="btn btn-outline-info">
                <i class="bi bi-chat-dots {{ session('locale', 'ar') === 'ar' ? 'ms-2' : 'me-2' }}"></i>
                {{ __('app.student_messages') }}
            </a>

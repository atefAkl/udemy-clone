...
class VideoLessonRequest extends FormRequest
{
    ...
    public function messages(): array
    {
        return [
            ...
            'duration.required'         => __('validation.custom.duration.required'),
            'duration.numeric'          => __('validation.custom.duration.numeric'),
            'duration.min'              => __('validation.custom.duration.min'),
